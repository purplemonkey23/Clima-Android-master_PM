...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "686ffb85b28ebc0ffcb9f0e4aeec68c1";
    ...
    private void getWeatherForCuttentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d("Clima", "longitude is:" + longitude + " -- Latidude is: "+ latitude);
